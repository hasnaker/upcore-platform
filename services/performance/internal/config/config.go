// Package config handles env-driven configuration for the performance service.
package config
...
// Load reads config from env / .env with defaults.
func Load() (*Config, error) {
	v := viper.New()
	v.SetDefault("PORT", "8014")
	...
	v.SetDefault("SERVICE_BUS_TOPIC", "performance-events")
