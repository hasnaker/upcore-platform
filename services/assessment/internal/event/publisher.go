...
// Event topics published by the assessment service.
const (
	TopicAssessmentCreated        = "assessment.created.v1"
	TopicAssessmentStarted        = "assessment.started.v1"
	TopicAssessmentCompleted      = "assessment.completed.v1"
	TopicAssessmentScored         = "assessment.scored.v1"
	TopicAssessmentReportRequested = "assessment.report.requested.v1"
)
