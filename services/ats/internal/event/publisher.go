// Package event defines the event publishing interface and in-memory
// implementations used when Azure Service Bus is unavailable (dev/test).
package event
...
// Event topics published by the ATS service.
const (
	TopicRequisitionOpened      = "ats.requisition.opened.v1"
	TopicRequisitionClosed      = "ats.requisition.closed.v1"
	TopicCandidateCreated       = "ats.candidate.created.v1"
	TopicApplicationSubmitted   = "ats.application.submitted.v1"
	TopicApplicationStageChanged = "ats.application.stage.changed.v1"
	TopicApplicationRejected    = "ats.application.rejected.v1"
	TopicApplicationHired       = "ats.application.hired.v1"
	TopicInterviewScheduled     = "ats.interview.scheduled.v1"
	TopicOfferSent              = "ats.offer.sent.v1"
	TopicOfferAccepted          = "ats.offer.accepted.v1"
	TopicOfferDeclined          = "ats.offer.declined.v1"
)
...
// NopPublisher discards events and just logs them. Used when Service Bus
...
// Publish logs the envelope and returns nil.
