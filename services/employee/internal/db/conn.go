...
// SetRLSTenant sets the current tenant for Postgres row-level-security policies.
// It sets both a local GUC (app.tenant_id) and the PG_SESSION one. The caller
// is responsible for scoping this to a transaction or reset afterwards.
