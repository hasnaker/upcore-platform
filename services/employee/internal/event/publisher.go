// Package event defines the event publishing interface and the in-memory
...
// Event topics published by the employee service.
const (
	TopicEmployeeCreated         = "employee.created.v1"
	TopicEmployeeUpdated         = "employee.updated.v1"
	TopicEmployeeTerminated      = "employee.terminated.v1"
	TopicEmployeePositionChange  = "employee.position.changed.v1"
	TopicEmployeeManagerChange   = "employee.manager.changed.v1"
	TopicEmployeeDeleted         = "employee.deleted.v1"
	TopicEmployeeImportCompleted = "employee.import.completed.v1"
)
