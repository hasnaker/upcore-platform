// Package event defines the event publishing interface for the intervention service.
package event
...
// Event topics published by the intervention service.
const (
	TopicAssigned             = "intervention.assigned.v1"
	TopicConsentGranted       = "intervention.consent.granted.v1"
