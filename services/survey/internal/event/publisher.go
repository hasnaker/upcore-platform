// Package event defines the event publishing interface for the survey service.
package event
...
// Event topics published by the survey service.
const (
	TopicScheduleCreated    = "survey.schedule.created.v1"
	TopicDistributed        = "survey.distributed.v1"
	TopicInvitationSent     = "survey.invitation.sent.v1"
	TopicResponseSubmitted  = "survey.response.submitted.v1"
	TopicSurveyClosed       = "survey.closed.v1"
	TopicAggregatesComputed = "survey.aggregates.computed.v1"
	TopicBurnoutRiskElevated = "survey.burnout.risk.elevated.v1"
	TopicReminderDue        = "survey.reminder.due.v1"
)
...
// NopPublisher discards events and logs them. Used when Service Bus is not configured.
