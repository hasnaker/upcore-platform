...
const TURKISH_HOLIDAYS_2026: { date: string; name: string }[] = [
  { date: '2026-01-01', name: 'Yilbasi' },
  { date: '2026-03-20', name: 'Ramazan Bayrami 1. Gun' },
  { date: '2026-03-21', name: 'Ramazan Bayrami 2. Gun' },
  { date: '2026-03-22', name: 'Ramazan Bayrami 3. Gun' },
  { date: '2026-04-23', name: '23 Nisan Ulusal Egemenlik ve Cocuk Bayrami' },
  { date: '2026-05-01', name: 'Emek ve Dayanisma Gunu' },
  { date: '2026-05-19', name: '19 Mayis Ataturk\'u Anma, Genclik ve Spor Bayrami' },
  { date: '2026-05-27', name: 'Kurban Bayrami 1. Gun' },
  { date: '2026-05-28', name: 'Kurban Bayrami 2. Gun' },
  { date: '2026-05-29', name: 'Kurban Bayrami 3. Gun' },
  { date: '2026-05-30', name: 'Kurban Bayrami 4. Gun' },
  { date: '2026-07-15', name: '15 Temmuz Demokrasi ve Milli Birlik Gunu' },
...
const balanceCards = [
  { label: 'Yillik Izin', total: 20, used: 6, icon: Umbrella, color: '#5E5CE6', accrualNote: 'Yillik hak: 20 gun (5-15 yil arasi, Madde 53)' },
  { label: 'Hastalik Izni', total: 10, used: 2, icon: Heart, color: '#DC2626', accrualNote: 'Yillik hak: 10 gun ucretli' },
  { label: 'Uzaktan Calisma', total: 30, used: 12, icon: Briefcase, color: '#D97706', accrualNote: 'Aylik max 10 gun' },
];
...
export default function IzinlerPage() {
  ...
  const dynamicBalanceCards = useMemo(() => {
          ...
          return (
            <div key={card.label} className="rounded-xl border border-[#EDEDED] bg-white">
              ...
              >
                ...
                <p className="mt-1 text-[11px] text-[#A3A3A3]">{card.used} gun kullanildi</p>
              </button>

              {/* Expanded: Leave balance history */}
              {isExpanded && (
                <div className="border-t border-[#EDEDED] px-5 py-4">
                  <p className="mb-3 text-xs font-semibold text-[#0A0A0A]">Bakiye Detayi</p>
                  <div className="mb-3 rounded-lg bg-[#F5F5F5] p-3">
                    <p className="text-xs text-[#525252]">{card.accrualNote}</p>
                    ...
                    <div className="mt-1 flex items-center justify-between text-xs">
                      ...
                      <span className="font-semibold" style={{ color: card.color }}>{remaining} gun</span>
                    </div>
                  </div>
                  <p className="mb-2 text-[11px] font-medium text-[#A3A3A3]">Kullanim gecmisi</p>
                  {myLeaves
                    .filter((l) => l.type === card.label && l.status === 'approved')
                    .slice(0, 5)
                    .map((l) => (
