...
export default function CalisanlarError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[calisanlar error]', {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-24 text-center">
      ...
      <h2 className="mt-4 text-lg font-semibold text-[#0A0A0A]">
        Calisan listesi yuklenemedi
      </h2>
      <p className="mt-1 max-w-sm text-sm text-[#525252]">
        Sunucuya baglanirken bir hata olustu. Lutfen tekrar deneyin veya daha
