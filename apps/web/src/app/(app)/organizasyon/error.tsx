...
export default function OrganizasyonError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[organizasyon error]', { message: error.message, digest: error.digest });
  }, [error]);
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center">
      ...
      <p className="mt-1 max-w-md text-[14px] text-[#888]">
        Organizasyon verileri yuklenirken bir sorun olustu. Lutfen tekrar deneyin.
      </p>
      <button
        type="button"
